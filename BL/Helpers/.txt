namespace Helpers
{
    ...
    /// <list type="bullet">
    /// <item>an event delegate for list observers - where there may be a change in the
    /// presentation of the list of entities</item>
    /// <item>an hash table of delegates for individual entity observers - indexed by appropriate entity ID</item>
    /// </list>
    /// </summary>
    class ObserverManager // stage 5
    {
        /// <summary>
        /// event delegate for list observers - it is called whenever there may be need to update the presentation
        ...
        /// table for it, thus providing memory effective storage for those observers
        /// </summary>
        ...
        {
            // check that there are any observers for the ID
